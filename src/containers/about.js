    ...
    <div className="about-container">
      <div className="inner">
        ...
        <div className="row">
          ...
          <div className="col-xs-12 col-sm-10 off-sm-1 col-md-3">
            ...
            <span className="about-container__link">Want to know more? <a href="#" className="about-container__link--hover link">send me a message</a></span>
          </div>
          <div className="col-xs-12 col-sm-10 off-sm-1 col-md-8 off-md-2">
